...
# How to automate the pipeline
  ...
  **2. Critical: make sure the brain extraction works well. For the 7T data, bet and fsl_anat failed to brain extract the images. Therefore, SPM segmentation tool was used to generate a grey, white and csf image; those were added together to get a brain mask.**
